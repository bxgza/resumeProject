          ...
          <div className={landingPageStyles.featuresContainer}>
            <div className={landingPageStyles.featuresHeader}>
              <h2 className={landingPageStyles.featuresTitle}>
                为什么选择 <span className={landingPageStyles.featuresTitleGradient}>超级简历?</span>
              </h2>
            ...
            <div className={landingPageStyles.featuresGrid}>
              {[
                  ...
                  {
                      icon: <LayoutTemplateIcon className={landingPageStyles.featureIcon} />,
                      title: "Pro Templates",
      ...
      <footer className={landingPageStyles.footer}>
          <div className={landingPageStyles.footerContainer}>
              <p className={landingPageStyles.footerText}>
                  ...
                  <a href="https://yuanbao.tencent.com/chat/naQivTmsDa/019694cb-008b-4781-ab63-5b0476342b2b" 
